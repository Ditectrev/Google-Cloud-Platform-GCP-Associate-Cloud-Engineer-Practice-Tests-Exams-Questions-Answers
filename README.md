...
| 108 | [A team of data scientists infrequently needs to use a Google Kubernetes Engine (GKE) cluster that you manage. They require GPUs for some long-running, non- restartable jobs. You want to minimize cost. What should you do?](#a-team-of-data-scientists-infrequently-needs-to-use-a-google-kubernetes-engine-gke-cluster-that-you-manage-they-require-gpus-for-some-long-running-non--restartable-jobs-you-want-to-minimize-cost-what-should-you-do) |
